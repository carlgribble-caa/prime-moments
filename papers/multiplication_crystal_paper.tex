...
minute. The graph-universe checks of Section~6 (\texttt{graph\_universe.py}) and the
explicit-formula pairing table of Section~4 (\texttt{diffraction\_pairing.py}) add seconds each. The weld laboratory, the recursion census, the skeleton-null scanner, and the extraction run add
