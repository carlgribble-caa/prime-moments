...
minute. The graph-universe checks of Section~6 (\texttt{graph\_universe.py}) add seconds. The weld laboratory, the recursion census, the skeleton-null scanner, and the extraction run add
