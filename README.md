...
| 4 | *The multiplication crystal: dimension, diffraction, and the symmetries of arithmetic* (expository) | `code/crystal_demos.py`, `code/untargeted_scan.py`, `code/graph_universe.py`, `code/diffraction_pairing.py`, `code/primon_gas.py`, `code/logic_column.py` |
...
| `papers/transfer_law_paper.tex` | Paper draft (WP-RH4–RH7): the prime content of the zeros' displacement field — the Debye–Waller transfer law (a = 1.15 ± 0.16, four windows + Dirichlet family, out of sample), the localization result, the overtone table with honest uncertainties, framed against Landau–Gonek/Odlyzko/Rudnick–Sarnak/Bogomolny–Keating per the librarian pass; awaits flagged full-text verification and author review |
