...
| 4 | *The multiplication crystal: dimension, diffraction, and the symmetries of arithmetic* (expository) | `code/crystal_demos.py`, `code/untargeted_scan.py`, `code/graph_universe.py`, `code/diffraction_pairing.py` |
