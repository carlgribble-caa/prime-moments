...
- **RH3b (done).** The two-interval plateau earned out of sample (post-hoc reading refused
  ...
  (`papers/positivity_lane.tex`; LaTeX not compiled in this environment — no TeX toolchain —
  flagged for a compile check at next opportunity).
